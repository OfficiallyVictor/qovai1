...
export default function HowItWorks() {
  return (
    <div className="px-4 pb-20">
      <div className="h-64 sm:h-72 lg:h-80  w-full sm:w-[550px] mt-10 grid place-content-center rounded-2xl mb-16 shadow-lg sm:mx-auto bg-gray-400 relative">
        <p className="lg:text-3xl text-xl text-white uppercase">How it Works</p>
